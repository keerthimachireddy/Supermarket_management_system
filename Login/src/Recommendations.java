...
public class Recommendations extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/crop (3).png"))); // NOI18N
...
try{
    Desktop.getDesktop().browse(new URL("https://pesticidewatch.org/").toURI());
}catch(Exception e){
